<template>
  <div class="relative w-full">
    <input :type="bloke" :autocomplete="autocomplete" v-model="userPassword" @focus="inputFocused = true"
      @blur="inputFocused = false" @input="handleInput($event)" :placeholder="t(`inputs.${props.type}`)" :class="[
