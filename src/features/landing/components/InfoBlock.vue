<template>
  <div ref="container" class="h-[calc(100vh-150px)] w-full bg-[#0f0f11] py-24 px-18 overflow-hidden">
    <div :class="divClass"
      ...
      <div class="flex flex-col justify-between items-start">
        <div class="relative flex">
          <img :class="[imgClass, showCircle ? 'opacity-100' : 'opacity-0']"
        ...
        <a href="#plans"
          class="cursor-pointer relative z-2 text-[#fff] bg-[#dc5b41] px-8 py-2 mx-6 rounded-lg hover:scale-105 transition-transform duration-300">
          {{ t(buttonText) }}
        </a>
      </div>
    </div>
